...
class CFMConfig:
    ...
    """
    # data
    data: GaussiansConfig = field(default_factory=GaussiansConfig)#lp
    # process 
    thermostat: ConstantThermostatConfig = field(default_factory=ConstantThermostatConfig)#lp
    # temporal network
    continuous_network: DeepMLPConfig = field(default_factory=DeepMLPConfig)#lp
    # ot

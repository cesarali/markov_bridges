...
class CJBConfig:
    ...
    temporal_network: Union[TemporalMLPConfig,
                            SequenceTransformerConfig, 
                            SimpleTemporalGCNConfig] = field(default_factory=TemporalMLPConfig) #lp
    # ot
    optimal_transport:OptimalTransportSamplerConfig = field(default_factory=OptimalTransportSamplerConfig) #lp
    # training
    trainer: CJBTrainerConfig = field(default_factory=CJBTrainerConfig) #lp
    #pipeline
    pipeline : BasicPipelineConfig = field(default_factory=BasicPipelineConfig) #lp

...
import markov_bridges.utils.molecules_utils as utils
from markov_bridges.data.abstract_molecules_dataset import MolecularDataModule, AbstractDatasetInfos
from markov_bridges.utils.rdkit_functions import mol2smiles, build_molecule_with_partial_charges
from markov_bridges.utils.rdkit_functions import compute_molecular_metrics
...
class QM9Dataset(InMemoryDataset):
    ...
    def __init__(self, stage, root, remove_h: bool, target_prop=None,
                 transform=None, pre_transform=None, pre_filter=None,max_num_mol=None):
    ...
    def process(self):
        ...
        number_of_molecules_processed = 0
        data_list = []
        for i, mol in enumerate(tqdm(suppl)):
            ...
            number_of_molecules_processed += 1
            if self.max_num_mol is not None:
                if number_of_molecules_processed >= self.max_num_mol:
                    break

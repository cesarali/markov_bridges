...
def plot_songs(original_sample,
    ...
    example_2_index_2 = get_song_index(song_1_index,repeat_sample,1)
    ...
    axs[0,2].plot(prepare_song(generative_sample[example_2_index_2],number_of_steps),"*",label="generative")
    axs[0,2].grid("True")
